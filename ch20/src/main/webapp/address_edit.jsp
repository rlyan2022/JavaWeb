...
<title><bean:message key="address_edit.page.title" /></title>
...
<TABLE width="100%" class="position">
	<TR>
		<TD><bean:message key="address_edit.page.position" /></TD>
		<TD align="right"><a href="address.do?method=back"><bean:message
			key="address_edit.page.back" /></a></TD>
		<TD width="20"></TD>
	</TR>
</TABLE>
<form name="form1" action="address_edit.do?method=update" method="post">
