...
<div id="listContent"> 
	<fieldset style="width:95%;">
		<legend><s:if test="id == null">上传餐店广告图片</s:if><s:else>修改餐店广告图片－${name}</s:else></legend>
    <div id="inputContent">
    <form id="inputForm" action="restaurant!savead.action" method="post" enctype="multipart/form-data">
	...
	<table class="inputView" style="margin-left:20px;">
		...
		<s:if test="logo != null">
			<tr height="30"> 
				<td>已上传的广告图片：</td>
				<td>
					<img src="${ctx}/upload/restaurant/${ad}" width="650" height="80"/>				
				</td>
			</tr>
		</s:if>
