...
<%
	...
	int totalPages = Pagination.getPages(linkNews.sumNews(servlet.requestInt(request,"kindId")));//取出总页数
%>
                ...
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="54%" align="center" background="../images/body_left.gif"><font color="red">最近更新：<%=linkNews.nearTime(servlet.requestInt(request,"kindId"))%></font></td>
