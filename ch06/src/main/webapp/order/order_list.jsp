...
<center>
      <TABLE width="778" border=0 cellPadding=0 cellSpacing=0 borderColor=#ffffff bgColor=#dee7ff style="FONT-SIZE: 10pt">
        <TBODY>
          ...
          bgColor=#dee7ff><FONT color=#f7f7f7> 订单管理<font color="#FFFFFF">&nbsp;</font></FONT> </TD>
      ...
      <TABLE width="778" border=0 align=center cellPadding=0 cellSpacing=0 borderColor=#ffffff style="FONT-SIZE: 10pt">
        <TBODY>
          ...
          <TR>
            ...
            <a href="#" onclick="openWin('ordermanage_addUI.do','addperson',600,200);">新增订单信息</a>
            </TD>
          </TR>
          <TR>
      ...
      <table width="778" border="0" cellPadding="0" cellSpacing="1" bgcolor="#6386d6">
	      ...
	      <tr bgcolor="#EFF3F7" class="TableBody1">
		      ...
		      <td width="10%" height="37" align="center"><B>产品数量</B></td>
		      <td width="10%" height="37" align="center"><B>订单时间</B></td>
         ...
         <s:if test="null != #request.pageView.records && !#request.pageView.records.isEmpty() ">
	      ...
	      <tr bgcolor="#EFF3F7" class="TableBody1" onmouseover="this.bgColor = '#DEE7FF';" onmouseout="this.bgColor='#EFF3F7';">
		      <td align="center" vAlign="center">${entity.orderNO }</td>
	          ...
	          <td align="center" vAlign="center">${entity.orderTime }</td>
	          <td align="center" vAlign="center">${entity.otherInfo }</td>
	          <td align="center" vAlign="center"><a href="#" onclick="del('ordermanage_del.do?orderNO=${entity.orderNO}');">删除</a>
	          <a href="#" onclick="openWin('ordermanage_updateUI.do?orderNO=${entity.orderNO}','addperson',600,200);">修改</a>
	          </td>
        </tr>
        </s:iterator>
		</s:if>
