...
<TABLE width="778" border=0 cellPadding=0 cellSpacing=0 borderColor=#ffffff bgColor=#dee7ff style="FONT-SIZE: 10pt">
        <TBODY>
          ...
          bgColor=#dee7ff><FONT color=#f7f7f7>产品类别查询<font color="#FFFFFF">&nbsp;</font></FONT> </TD>
...
<TABLE class="tableEdit" border="0" cellspacing="1" cellpadding="0" style="width:580px;">
	<TBODY>
		<TR>
			<!-- 这里是添加、编辑界面的标题 -->
			<td align="center" class="tdEditTitle">查询产品类别信息</TD>
		</TR>
		<TR>
			<td>
			<!-- 主输入域开始 -->
<table class="tableEdit" style="width:778px;" cellspacing="0" border="0" cellpadding="0">
	<tr>
		<td class="tdEditLabel">类别编号</td>
		<td class="tdEditContent"><input type="text" name="producttypeNO" ></td>
	</tr>
	<tr>
