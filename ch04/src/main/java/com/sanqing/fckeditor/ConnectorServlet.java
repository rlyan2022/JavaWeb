...
public class ConnectorServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!RequestCycleHandler.isEnabledForFileUpload(request))
            ur = new UploadResponse(new Object[]{new Integer(UploadResponse.SC_SECURITY_ERROR), null, null,
                    Messages.NOT_AUTHORIZED_FOR_UPLOAD});
        else if (!CommandHandler.isValidForPost(commandStr))
            ur = new UploadResponse(new Object[]{new Integer(UploadResponse.SC_ERROR), null, null, Messages.INVALID_COMMAND});
        else if (typeStr != null && !ResourceTypeHandler.isValid(typeStr))
            ur = new UploadResponse(new Object[]{new Integer(UploadResponse.SC_ERROR), null, null, Messages.INVALID_TYPE});
        else if (!UtilsFile.isValidPath(currentFolderStr))
            ...
            if (!currentDir.exists())
                ...
                try {
                    ...
                    if (!ExtensionsHandler.isAllowed(resourceType, extension))
                        ur = new UploadResponse(new Object[]{new Integer(UploadResponse.SC_INVALID_EXTENSION)});
                    else {
                        ...
                        if (Utils.isEmpty(newFilename))
                            ur = new UploadResponse(new Object[]{new Integer(UploadResponse.SC_OK), UtilsResponse
                                    .constructResponseUrl(request, resourceType, currentFolderStr,
                                            true, ConnectorHandler.isFullUrl()).concat(filename)});
                        else
                            ur = new UploadResponse(new Object[]{new Integer(UploadResponse.SC_RENAMED),
                    ...
                    ur = new UploadResponse(new Object[]{new Integer(UploadResponse.SC_SECURITY_ERROR)});
                }
            }
